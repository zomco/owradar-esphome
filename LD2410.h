...
public:
    ...
    int maxMovingDistanceRange = 1;
    int maxStillDistanceRange = 1;
    int noneDuration = 0;
    ...
    void setNumbers(int maxMovingDistanceRange_, int maxStillDistanceRange_, int noneDuration_){
    ...
    void setMaxDistancesAndNoneDuration(int maxMovingDistanceRange_, int maxStillDistanceRange_, int noneDuration_)
    {
        char cmd[2] = {0x60, 0x00};
        char value[18] = {0x00, 0x00, lowByte(maxMovingDistanceRange_), highByte(maxMovingDistanceRange_), 0x00, 0x00, 0x01, 0x00, lowByte(maxStillDistanceRange_), highByte(maxStillDistanceRange_), 0x00, 0x00, 0x02, 0x00, lowByte(noneDuration_), highByte(noneDuration_), 0x00, 0x00};
